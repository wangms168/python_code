...
cookies = {
    ...
    'yfx_f_l_v_t_10000042': 'f_t_1672978431664__r_t_1673058380499__v_t_1673058380499__r_c_1',
    'ba17301551dcbaf9_gdp_sequence_ids': '{%22globalKey%22:46%2C%22VISIT%22:6%2C%22PAGE%22:9%2C%22VIEW_CLICK%22:33}',
}
...
def textParse(text):
    ...
    主板A         = result[0]        # 主板A
    主板A_成交金额 = float(主板A['TRADE_AMT'].replace(',', ''))
    科创版   = result[2]        # 科创版
    科创版_成交金额 = float(科创版['TRADE_AMT'].replace(',', ''))
    
    return 主板A_成交金额, 科创版_成交金额
